...
public class PracticeFragment extends Fragment {
    ...
    DatabaseReference dataRef = rootRef.child(DATA).child(PRACTICE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerPractice = view.findViewById(R.id.recycler_practice);
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(getContext());
        mLinearLayoutManager.setReverseLayout(true);
        mLinearLayoutManager.setStackFromEnd(true);
        recyclerPractice.setLayoutManager(mLinearLayoutManager);
        recyclerPractice.setHasFixedSize(true);
        return view;
    }
    ...
    public void onStart() {
                    ...
                    protected void populateViewHolder(TeamViewholder viewHolder, Match model, final int position) {
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                monitorIntent.putExtra("type", PRACTICE);
        ...
        recyclerPractice.setAdapter(adapter);
    }
