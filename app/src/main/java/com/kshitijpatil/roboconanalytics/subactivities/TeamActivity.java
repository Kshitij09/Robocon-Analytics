...
public class TeamActivity extends AppCompatActivity {
    ...
    DatabaseReference teamDataRealRef = rootRef.child(TEAMSDATA).child(PRACTICE);
    ...
    private void handleStatusUpdate() {
        practiceRef.addChildEventListener(new ChildEventListener() {
            @Override
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                Log.d(TAG, "onChildChanged: "+dataSnapshot.getRef().getParent().getKey());
    ...
    private void initGraph() {
        chart = findViewById(R.id.practice_chart);
